...
QUIT"""
    ...
    txt = Reader(unicode(text.expandtabs(4),'utf8'),(20,20),660,15,height=360,font=os.path.join(thisrep,'MonospaceTypewriter.ttf'),bg=pygame.image.load(os.path.join(thisrep,'bg.jpg')),fgcolor=(255,255,255),hlcolor=(255,10,150,100),split=True)
    txt.show()
